...
<body>
    ...
    <div class="container">
        <div class="form-box">
            <a href="index.jsp"><img src="images/svg/xmark.svg" class="cls-btn"></a> <img alt="" src="images/logo.png" width="175" height="50">
			<p>WELCOME</p>
            <form action="#">
                ...
                <div class="terms">
                    <input type="checkbox" required> I agree with <a href="#">Terms & Conditions</a>
                </div>
